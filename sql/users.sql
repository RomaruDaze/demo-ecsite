-- 0. Reset the table for development
DROP TABLE if EXISTS users

-- 1. Create the 'users' table
CREATE TABLE users (
                       id SERIAL PRIMARY KEY, -- (Note: Postgres uses SERIAL instead of INT AUTO_INCREMENT)
                       ...
                       role VARCHAR(50) DEFAULT 'USER' -- NEW: role column
);

-- 2. Insert mock data
INSERT INTO users (name, email, password, zipcode, prefecture, municipalities, address, telephone, role)
VALUES
